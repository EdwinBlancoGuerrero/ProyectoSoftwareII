...
class CitasM extends ConexionBD{
	...
	static public function EnviarCitaM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::conectarBD()->prepare("INSERT INTO $tablaBD (id_doctor, id_consultorio, id_paciente, nyaP, documento, inicio, fin) VALUES (:id_doctor, :id_consultorio, :id_paciente, :nyaP, :documento, :inicio, :fin)");
	...
	static public function PedirCitaDoctorM($tablaBD, $datosC){
		...
		$pdo = ConexionBD::conectarBD()->prepare("INSERT INTO $tablaBD (id_doctor, id_consultorio, nyaP, documento, inicio, fin) VALUES (:id_doctor, :id_consultorio, :nyaP, :documento, :inicio, :fin)");
