...
<div class="content-wrapper">
	<section class="content-header">
		...
		if ($resultado["sexo"] == "Femenino") {
			...
			echo '<h1 name="nyaD" id="nyaD">Doctora: ' . $resultado["apellido"] . ' ' . $resultado["nombre"] . '</h1>';
		} else {

			echo '<h1 name="nyaD" id="nyaD">Doctor: ' . $resultado["apellido"] . ' ' . $resultado["nombre"] . '</h1>';
		}
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						echo '<div class="form-group">
								...
								<input type="hidden" name="correoP" value="' . $_SESSION["correo"] . '">
						...
						echo'<input type="hidden" name="nyaD" value="' . $resultado["nombre"] . ' ' . $resultado["apellido"] . '">';
