...
<div class="content-wrapper">	
	<section class="content-header">		
		<h1><font face="Comic Sans MS,arial,verdana">Gestor de Secretarias</font></h1>
	</section>
						...
						foreach ($resultado as $key => $value) {							
							echo '<tr>
									...
									<td>
										...
										<div class="btn-group">											
											<button class="btn btn-danger EliminarSecretaria" Sid="'.$value["identificacion"].'" imgS="'.$value["foto"].'"><i class="fa fa-times"></i> Borrar</button>											
										</div>
									</td>
								</tr>';
