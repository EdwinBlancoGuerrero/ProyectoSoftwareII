...
<div class="content-wrapper">
    <section class="content-header">
        <h1><font face="Comic Sans MS,arial,verdana">Gestor de pacientes</font></h1>
    </section>
                            ...
                            echo '<td>' . $value["usuario"] . '</td>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-success EditarPaciente" Pid="' . $value["id"] . '" 
                                        data-toggle="modal" data-target="#EditarPaciente"><i class="fa fa-pencil"></i> Editar</button>
...
<script type="text/javascript">
    function ConfirmarEliminar() {
        var respesta = confirm("Estás seguro de eliminar el registo?");
        if (respesta == true) {
            return true;
        } else {
            return false;
