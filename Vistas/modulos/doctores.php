...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <font face="Comic Sans MS,arial,verdana">Gestor de doctores</font>
        </h1>
    </section>
                            ...
                            echo '<td>' . $consultorio["nombre"] . '</td>
                                            ...
                                            <td>
                                                <div class="btn-group"> 
                                                    ...
                                                    <button onclick="return ConfirmarEliminar()" class="btn btn-danger EliminarDoctor" Did="' . $value["id"] . '" imgD="' . $value["foto"] . '" ><i class="fa fa-times"></i> Borrar</button>   
