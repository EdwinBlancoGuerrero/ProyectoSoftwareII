...
<body class="hold-transition skin-blue sidebar-mini login-page">
    ...
    if (isset($_SESSION["Ingresar"]) && $_SESSION["Ingresar"] == true) {
        ...
        if (isset($_GET["url"])) {
            ...
            if (
                $url[0] == "inicio" || $url[0] == "salir" || $url[0] == "perfil-Secretaria" || $url[0] == "perfil-S"
                ...
                || $url[0] == "perfil-A" || $url[0] == "secretarias" || $url[0] == "inicio-editar" || $url[0] == "historialCitas" || $url[0] == "historialCitas" 
            ) {
    ...
    <!-- fullCalendar -->
    <script src="//localhost/clinica/Vistas/bower_components/moment/moment.js"></script>
    <script src="//localhost/clinica/Vistas/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>

    <script src="//localhost/clinica/Vistas/bower_components/fullcalendar/dist/locale/es.js"></script>
