...
class PacientesC
{
    ...
    public function CrearPacienteC()
    {
        if (isset($_POST["rolP"])) {
            ...
            $tablaBD = "pacientes";
            $datosC = array(
                "apellido" => $_POST["apellido"], "nombre" => $_POST["nombre"], "documento" => $_POST["documento"], "correo" => $_POST["correo"],
                "usuario" => $_POST["usuario"], "clave" => $_POST["clave"], "rol" => $_POST["rolP"]
            );
     ...
     //Crear paciente
     public function CrearPacienteRegistroC()
     {
         if (isset($_POST["rolP"])) {
    ...
    public function ActualizarPacienteC()
    {
        if (isset($_POST["Pid"])) {
            ...
            $tablaBD = "pacientes";
            $datosC = array("id" => $_POST["Pid"], "apellido" => $_POST["apellidoE"], "nombre" => $_POST["nombreE"], "documento" => $_POST["documentoE"], "correo" => $_POST["correoE"], "usuario" => $_POST["usuarioE"], "clave" => $_POST["claveE"]);
    ...
    public function ActualizarPerfilPacienteC(){
        ...
        if(isset($_POST["Pid"])){
            ...
            "clave"=>$_POST["clavePerfil"], "documento"=>$_POST["documentoPerfil"], "correo"=>$_POST["correoPerfil"], "foto"=>$rutaImg);
